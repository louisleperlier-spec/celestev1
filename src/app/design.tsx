...
/**
 * Écran de vérification du design system (outil de développement, route /design).
 */
...
export default function DesignSystemScreen() {
  ...
  return (
    <Screen scroll contentStyle={styles.content}>
      ...
      <Button label="Plus tard" variant="dark" />

      <Text variant="title">Sélection</Text>
      {LEVELS.map((l) => (
        <SelectableCard key={l} selected={level === l} onPress={() => setLevel(l)} style={styles.selectable}>
