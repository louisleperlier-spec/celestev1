...
type Onglet = { label: string; icon: IconName; href?: '/accueil' | '/programme'; ecran?: Parameters<typeof bientot>[0] };
...
const ONGLETS: Onglet[] = [
  ...
  { label: 'Progrès', icon: 'chart', ecran: 'progres' },
  { label: 'Profil', icon: 'user', ecran: 'profil' },
];
