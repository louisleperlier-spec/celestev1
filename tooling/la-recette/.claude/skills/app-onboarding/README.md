...
Run `/app-onboarding` from your app project and the skill will:
...
The framework is based on analysis of the onboarding flows of some of the best-converting subscription apps in the App Store (e.g. the Mob recipe app's ~19-screen flow), widely regarded as a gold-standard reference.

## Credits & License

This skill is based on the open-source `app-onboarding-questionnaire` skill by Adam Lyttle, distributed under the MIT License. The original copyright notice is retained in the `LICENSE` file, as required.
